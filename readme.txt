...
3、百度分享插件默认嵌入的是“中等图标”代码，支持划词分享。如果您想更换其他按钮风格或希望对网站的分享数据进行追踪与分析，请到百度分享官网<a href="http://share.baidu.com/" target="_blank">获取代码或数据分析</a>，并在登录状态下获取新代码。然后在Wordpress后台的 “设置->百度分享按钮” 中将您的代码填入文本框中并提交即可。
